...
var index_es_default = (/* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		return function() {
			...
			class C {
				...
				_getClassName() {
					var e;
					let t = /* @__PURE__ */ new Date(), { selectOtherMonths: s, selectOtherYears: a } = this.opts, { minDate: n, maxDate: r, isDateDisabled: h } = this.dp, { day: l } = o(this.date), d = this._isOutOfMinMaxRange(), c = h(this.date), m = u("air-datepicker-cell", `-${this.singleType}-`, {
				...
				_getHtml() {
					...
					switch (this.type) {
						case i.days: return !n && this.isOtherMonth ? "" : a;
						case i.months: return this.dp.locale[this.opts.monthsField][s];
						case i.years: return !r && this.isOtherDecade ? "" : t;
					}
				}
				_isOutOfMinMaxRange() {
					...
					_(this, "handleClick", ((e) => {
						...
						switch (this.dp.currentView) {
							...
							case i.months:
								...
								break;
							case i.years: if (s[0] === a[0] && s[1] === a[1]) return;
						}
						this.render();
					})), _(this, "render", (() => {
			...
			var x = {
				today: {
					...
					onClick: (e) => e.setViewDate(/* @__PURE__ */ new Date())
				},
				clear: {
			...
			class O {
				constructor(e) {
					let { dp: t, opts: i } = e;
					A(this, "pressedKeys", /* @__PURE__ */ new Set()), A(this, "hotKeys", new Map([
						[[["Control", "ArrowRight"], ["Control", "ArrowUp"]], (e) => e.month++],
						[[["Control", "ArrowLeft"], ["Control", "ArrowDown"]], (e) => e.month--],
						[[["Shift", "ArrowRight"], ["Shift", "ArrowUp"]], (e) => e.year++],
						[[["Shift", "ArrowLeft"], ["Shift", "ArrowDown"]], (e) => e.year--],
						[[["Alt", "ArrowRight"], ["Alt", "ArrowUp"]], (e) => e.year += 10],
						[[["Alt", "ArrowLeft"], ["Alt", "ArrowDown"]], (e) => e.year -= 10],
						[[
							"Control",
							"Shift",
							"ArrowUp"
						...
						if ("Enter" === t) {
							...
							if (a) {
								...
								e ? s._handleAlreadySelectedDates(e, a) : s.selectDate(a);
								return;
							}
						}
				...
				getInitialFocusDate() {
					...
					if (!r) switch (t) {
						case i.days:
							r = new Date(a, n, (/* @__PURE__ */ new Date()).getDate());
							break;
						case i.months:
							r = new Date(a, n, 1);
							break;
						case i.years: r = new Date(a, 0, 1);
					}
					return r;
				}
				focusNextCell(e) {
					...
					switch (e) {
						...
						case "ArrowRight":
							s === a && (c += 1), s === n && (d += 1), s === r && (l += 1);
							break;
						case "ArrowDown": s === a && (c += 7), s === n && (d += 3), s === r && (l += 4);
					}
					...
					if (I(this, "viewIndexes", [
						...
						switch (this.currentView) {
							...
							case i.months:
								...
								break;
							case i.years: this.setViewDate(new Date(e + 10, 0, 1));
						}
					})), I(this, "prev", (() => {
						let { year: e, month: t } = this.parsedViewDate;
						switch (this.currentView) {
						...
						if (a) r.$datepicker.style.cssText = "left: 50%; top: 50%";
							...
							switch (g) {
								...
								case "left":
									s = h.left;
									break;
								case "center": /left|right/.test(v) ? i = h.top + h.height / 2 - d.height / 2 : s = h.left + h.width / 2 - d.width / 2;
							}
						...
						let { hours: t, minutes: i } = e, s = /* @__PURE__ */ new Date(), { lastSelectedDate: a, opts: { onSelect: n } } = this, r = a;
						a || (r = s);
					...
					if ((e = b(e)) instanceof Date) {
						...
						if (a === i.days && e.getMonth() !== n.month && l && (t = new Date(e.getFullYear(), e.getMonth(), 1)), a === i.years && e.getFullYear() !== n.year && d && (t = new Date(e.getFullYear(), 0, 1)), t && this.setViewDate(t), c && !u) {
							...
							case 2:
								...
								break;
							default: this.selectedDates = [e], this.rangeDateFrom = e;
						}
...
//#endregion
export { index_es_default as default };
